  ...
  <footer class="mx-auto max-w-screen-2xl px-4 md:px-8">
    <div class="flex flex-col items-center justify-between gap-4 border-t border-b py-6 md:flex-row">
      ...
      <div class="flex gap-8">
        <a href="https://www.bookmyshow.com/" target="_blank" class="text-gray-200 transition duration-100 hover:text-gray-500 active:text-gray-600">
    ...
    <div class="py-8 text-center text-sm text-gray-400">© 2025 - Cineverse. All rights reserved.</div>
  </footer>
</div>
    </>
  )
